...
| [data-science](skills/data-science/) | Documentation entry points for data-analysis and scientific-computing domains — information only — plus opinionated project scaffolds that declare their defaults | Per project, on top of `core`, only when the target analyzes data or does scientific computing |
