...
syntax and index URLs against the uv PyTorch guide,
<https://docs.astral.sh/uv/guides/integration/pytorch/> (the uv docs
publish an llms.txt index), before committing.
