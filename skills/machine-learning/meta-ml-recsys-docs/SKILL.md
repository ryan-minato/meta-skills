...
description: >-
  ...
  recommender-system project to authoritative documentation entry points
  — ranking and retrieval frameworks (TorchRec, TensorFlow Recommenders,
  NVIDIA Merlin, RecBole, DeepCTR, implicit, LightFM) and the ANN
  retrieval beneath them (Faiss, ScaNN). Use when a harness build must
  record where the docs live for a project that builds recommendation,
