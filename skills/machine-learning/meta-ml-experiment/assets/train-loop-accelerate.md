# Accelerate Training Loop — Pydantic Settings Variant
...
docs own today's signatures. Wire the `config.yaml` loading per the
current Pydantic Settings docs (<https://docs.pydantic.dev/>, llms.txt
available).
