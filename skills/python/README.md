...
| [meta-python-pypi-docs](meta-python-pypi-docs/) | Locates a package's authoritative documentation entry point from PyPI/conda metadata, preferring an agent-oriented `.md` or `llms.txt` rendition, for packages no docs map already records |
